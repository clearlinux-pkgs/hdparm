...
Version  : 9.63
Release  : 20
URL      : https://sourceforge.net/projects/hdparm/files/hdparm/hdparm-9.63.tar.gz
Source0  : https://sourceforge.net/projects/hdparm/files/hdparm/hdparm-9.63.tar.gz
...
%prep
%setup -q -n hdparm-9.63
cd %{_builddir}/hdparm-9.63
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641853384
...
cp %{_builddir}/hdparm-9.63/LICENSE.TXT %{buildroot}/usr/share/package-licenses/hdparm/88e79deadef14cb3a3ca419bb731f1deb5ffa7c3
cp %{_builddir}/hdparm-9.63/debian/copyright %{buildroot}/usr/share/package-licenses/hdparm/521ecd1edcba0923d0ffbf7ae9af6726d97afe78
cp %{_builddir}/hdparm-9.63/wiper/GPLv2.txt %{buildroot}/usr/share/package-licenses/hdparm/ef1bcf369e4124b5f2558fefee17972f41b76cab
%make_install
