...
Source0  : https://sourceforge.net/projects/hdparm/files/hdparm/hdparm-9.64.tar.gz
...
%prep
%setup -q -n hdparm-9.64
cd %{_builddir}/hdparm-9.64
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657477004
...
cp %{_builddir}/hdparm-9.64/LICENSE.TXT %{buildroot}/usr/share/package-licenses/hdparm/88e79deadef14cb3a3ca419bb731f1deb5ffa7c3
cp %{_builddir}/hdparm-9.64/debian/copyright %{buildroot}/usr/share/package-licenses/hdparm/521ecd1edcba0923d0ffbf7ae9af6726d97afe78
cp %{_builddir}/hdparm-9.64/wiper/GPLv2.txt %{buildroot}/usr/share/package-licenses/hdparm/ef1bcf369e4124b5f2558fefee17972f41b76cab
%make_install
