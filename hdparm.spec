...
Version  : 9.60
Release  : 17
URL      : https://sourceforge.net/projects/hdparm/files/hdparm/hdparm-9.60.tar.gz
Source0  : https://sourceforge.net/projects/hdparm/files/hdparm/hdparm-9.60.tar.gz
...
%prep
%setup -q -n hdparm-9.60
cd %{_builddir}/hdparm-9.60
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606233572
...
cp %{_builddir}/hdparm-9.60/LICENSE.TXT %{buildroot}/usr/share/package-licenses/hdparm/88e79deadef14cb3a3ca419bb731f1deb5ffa7c3
cp %{_builddir}/hdparm-9.60/debian/copyright %{buildroot}/usr/share/package-licenses/hdparm/521ecd1edcba0923d0ffbf7ae9af6726d97afe78
cp %{_builddir}/hdparm-9.60/wiper/GPLv2.txt %{buildroot}/usr/share/package-licenses/hdparm/ef1bcf369e4124b5f2558fefee17972f41b76cab
%make_install
